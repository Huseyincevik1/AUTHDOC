...
export default function HowItWorks() {
  return (
    <section className='how-it-works-container mt-10'>
      <div className='how-it-works-wrapper'>
        ...
        <div className='how-it-works-content'>
          ...
          <div className='how-it-work-card'>
            ...
            <div className='card-description'>
              <span className='font-bold'>Activation of Smart Contracts </span>:
              The platform activates smart contracts on the blockchain to verify
              the accuracy of the provided information. <br />
              <br />{' '}
          ...
          <div className='how-it-work-card'>
            ...
            <div className='card-description'>
              ...
              <br />
              <br />
              <span className='font-bold'>Employer Confirmation </span>: The
